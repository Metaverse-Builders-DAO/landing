...
const titleDefault = 'Metaverse Builders DAO'
const url = 'https://mbd.gg/'
const description =
  'Metaverse Builders DAO is a service DAO that seeks to accelerate the development of experiences in the Metaverse'
